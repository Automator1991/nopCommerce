...
public class Stepdef extends BaseClass {
	...
	public void page_Title_should_be(String exptitle) throws InterruptedException {
		...
		if (driver.getPageSource().contains("Login was unsuccessful")) {
			...
			System.out.print("Expected Title >>>>>>" + exptitle);
			System.out.print("Actual Title >>>>>>" + driver.getTitle());
	...
	public void clickOnCustomersRolesItem() {
		addCustRolePage=new AddCustomerRolePage(driver);
		addCustRolePage.clickCustomerRole();
	}

	@Then("User can view Add new customer Roles page")
	public void userCanViewAddNewCustomerRolesPage() {
		addCustRolePage.getPageTitle();
	}

	@When("User enter customer Role info")
	public void userEnterCustomerRoleInfo() {
		addCustRolePage.setName("Ibrahim");
		addCustRolePage.clickOnFreeShipping();
		addCustRolePage.clickOnActive();
