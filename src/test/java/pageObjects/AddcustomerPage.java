...
public class AddcustomerPage extends utility {
	...
	By lnkCustomers_menuitem=By.xpath("//ul[@class='nav nav-treeview']/li/a/p[text()=' Customers']");
	...
	public void  setNewsletter() {
		...
		//ldriver.findElement(txtNewsletter).sendKeys(yes);
		// ldriver.findElement(By.xpath("//option[text()='Your store name']")).click();


   WebElement el = ldriver.findElement(By.xpath("//li[contains(text(),'Your store name')]"));



		javaScriptClick(el,ldriver);
	...
	public void setCustomerRoles(String role) throws InterruptedException 
		{
			...
			javaScriptClick(listitem,ldriver);
